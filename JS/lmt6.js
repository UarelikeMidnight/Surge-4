    ...
    await inner_check()
      .then((code) => {
        if (code === 'Not Available') {
          ...
          youtube_check_result += "➤" + flags.get(region.toUpperCase())
        }
      })
      .catch((error) => {
        youtube_check_result += '񑀀'
      })
  ...
  async function check_netflix() {
    ...
    await inner_check(81215567)
      .then((code) => {
        ...
        netflix_check_result += '✔' + flags.get(region.toUpperCase())
      ...
      .then((code) => {
        ...
        netflix_check_result += '自制' + flags.get(region.toUpperCase())
        return Promise.reject('BreakSignal')
      })
      .catch((error) => {
